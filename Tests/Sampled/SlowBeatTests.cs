...
public class SlowBeatTests(ITestOutputHelper output) : TestBase(output)
{
    ...
    public void SlowBeat_GetSequence1_ReturnExpected()
    {
        ...
        string[] expected = [
            ...
            "2500:k",
            "3000:k",
            "4000:sequence-end-" + sequence.Name + ": 4000 ms",
            ...
            "6500:k",
            "7000:k",
            "8000:sequence-end-" + sequence.Name + ": 4000 ms",
            ...
            "10500:k",
            "11000:k",
            "12000:sequence-end-" + sequence.Name + ": 4000 ms",
            ...
            "16000:sequence-end-" + sequence.Name + ": 4000 ms",
        ];
    ...
    public void SlowBeat_GetSequence2_ReturnExpected()
    {
        ...
        string[] expected = [
            ...
            "1500:s",
            "2000:k",
            "3400:sequence-end-" + sequence.Name + ": 3400 ms",
            ...
            "4900:s",
            "5400:k",
            "6800:sequence-end-" + sequence.Name + ": 3400 ms",
            ...
            "8300:s",
            "8800:k",
            "10200:sequence-end-" + sequence.Name + ": 3400 ms",
            ...
            "13600:sequence-end-" + sequence.Name + ": 3400 ms",
        ];
    ...
    public void SlowBeat_GetSequence3_ReturnExpected()
    {
        ...
        string[] expected = [
            ...
            "3000:s",
            "3500:k",
            "4800:sequence-end-" + sequence.Name + ": 4800 ms",
            ...
            "7800:s",
            "8300:k",
            "9600:sequence-end-" + sequence.Name + ": 4800 ms",
            ...
            "12600:s",
            "13100:k",
            "14400:sequence-end-" + sequence.Name + ": 4800 ms",
            ...
            "19200:sequence-end-" + sequence.Name + ": 4800 ms",
        ];
    ...
    public void SlowBeat_GetSequence4_ReturnExpected()
    {
        ...
        string[] expected = [
            ...
            "5220:k",
            "5620:s",
            "6400:sequence-end-" + sequence.Name + ": 6400 ms",
            ...
            "11620:k",
            "12020:s",
            "12800:sequence-end-" + sequence.Name + ": 6400 ms",
            ...
            "18020:k",
            "18420:s",
            "19200:sequence-end-" + sequence.Name + ": 6400 ms",
            ...
            "25600:sequence-end-" + sequence.Name + ": 6400 ms",
        ];
    ...
    public void SlowBeat_GetSequence5_ReturnExpected()
    {
        ...
        string[] expected = [
            ...
            "2200:k",
            "2400:s",
            "3200:sequence-end-" + sequence.Name + ": 3200 ms",
            ...
            "5400:k",
            "5600:s",
            "6400:sequence-end-" + sequence.Name + ": 3200 ms",
            "6400:sequence-start-" + sequence.Name,
            "6400:k",
            "6600:k",
            "6800:k",
            ...
            "8600:k",
            "8800:s",
            "9600:sequence-end-" + sequence.Name + ": 3200 ms",
            "9600:sequence-start-" + sequence.Name,
            "9600:k",
            "9800:k",
            "10000:k",
            ...
            "12800:sequence-end-" + sequence.Name + ": 3200 ms",
        ];
