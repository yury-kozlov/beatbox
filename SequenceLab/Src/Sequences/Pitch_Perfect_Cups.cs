        ...
        return new Sequence
        {
            Leader = new Metronome()
            {
                ...
                Followers = new()
                {
                    ...
                    new Sound("k") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 80 }},
                    new Sound("k") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 130 }},
                    new Sound("s") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 270 }},
                    new Sound("s") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 215 }},
                    ...
                    new Sound("k") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 240 }},
                    new Sound("k") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 215 }},
                    new Sound("k") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 240 }},
                    new Sound("s") { Strategy = new FollowPreviousSoundStrategy() {DelayAfterLeader = 225 }},
